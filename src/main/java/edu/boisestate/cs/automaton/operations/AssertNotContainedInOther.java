 ...
 *
 */
public class AssertNotContainedInOther
        extends Operation {

    private final AutomatonModelFactory modelFactory;
    private final AutomatonModel notContainingModel;

    public AssertNotContainedInOther(AutomatonModel notContainingModel,
                                     AutomatonModelFactory modelFactory) {
        this.notContainingModel = notContainingModel;
