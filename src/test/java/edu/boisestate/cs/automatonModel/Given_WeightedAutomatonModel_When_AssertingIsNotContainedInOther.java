...
public class Given_WeightedAutomatonModel_When_AssertingIsNotContainedInOther {
    ...
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Concrete", "Uniform", 84, concreteModel, uniformModel},
                {"Concrete", "Non-uniform", 44, concreteModel, nonUniformModel},
                ...
                {"Uniform", "Uniform", 6756, uniformModel, uniformModel},
                {"Uniform", "Non-uniform", 3558, uniformModel, nonUniformModel},
                ...
                {"Non-uniform", "Uniform", 3681, nonUniformModel, uniformModel},
                {"Non-uniform", "Non-uniform", 1881, nonUniformModel, nonUniformModel}
        });
    }
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format( "Expected Model Count Invalid for <%s Automaton Model>.assertNotContainedInOther(<%s Automaton Model>)",
                                       baseDescription,
                                       argDescription);
