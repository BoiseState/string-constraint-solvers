...
public class Given_BoundedAutomatonModel_When_GettingAllSubstrings {
    ...
    private AutomatonModel substringsModel;


    @Parameters(name = "{index}: <{0} Automaton Model>.allSubstrings() - Expected MC = {1}")
    ...
    public void setup() {
        // *** act ***
        this.substringsModel = this.model.allSubstrings();
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        // *** act ***
        int modelCount = this.substringsModel.modelCount().intValue();
