...
public class Given_UnboundedAutomatonModel_When_AssertingEquals {
    ...
    @Parameters(name = "{index}: <{0} Automaton Model>.assertEquals(<{1} Automaton Model>) - Expected MC = {2}")
    ...
    public void setup() {
        // *** act ***
        this.equalModel = this.baseModel.assertEquals(this.argModel);
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format( "<%s Automaton Model>.assertEquals(<%s Automaton Model>)", baseDescription, argDescription);
