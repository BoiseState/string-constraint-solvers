...
public class Given_WeightedAutomatonModel_When_AssertingStartsWith {
    ...
    private AutomatonModel startsWithModel;

    @SuppressWarnings("Duplicates")
    @Parameters(name = "{index}: <{0} Automaton Model>.assertStartsWith(<{1} Automaton Model>) - Expected MC = {2}")
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Concrete", "Uniform", 4, concreteModel, uniformModel},
                ...
                {"Uniform", "Non-uniform", 93, uniformModel, nonUniformModel},
                ...
                {"Non-uniform", "Uniform", 171, nonUniformModel, uniformModel},
    ...
    public void setup() {
        // *** act ***
        this.startsWithModel = this.baseModel.assertStartsWith(this.argModel);
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        // *** act ***
        int modelCount = this.startsWithModel.modelCount().intValue();

        // *** assert ***
        String reason = String.format( "Expected Model Count Invalid for <%s Automaton Model>.assertStartsWith(<%s Automaton Model>)",
                                       baseDescription,
                                       argDescription);
