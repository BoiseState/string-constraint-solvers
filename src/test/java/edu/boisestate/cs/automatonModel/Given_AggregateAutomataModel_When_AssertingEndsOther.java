...
public class Given_AggregateAutomataModel_When_AssertingEndsOther {
    ...
    private AutomatonModel endModel;

    @SuppressWarnings("Duplicates")
    @Parameters(name = "{index}: <{0} Automaton Model>.assertEndsOther(<{1} Automaton Model>) - Expected MC = {2}")
    ...
    public void setup() {
        // *** act ***
        this.endModel = this.baseModel.assertEndsOther(this.argModel);
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format( "<%s Automaton Model>.assertEndsOther(<%s Automaton Model>)",
                                       baseDescription,
                                       argDescription);
