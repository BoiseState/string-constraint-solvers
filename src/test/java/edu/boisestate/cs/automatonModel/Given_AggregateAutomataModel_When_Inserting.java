...
public class Given_AggregateAutomataModel_When_Inserting {
    ...
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Uniform", "Non-Uniform", 4122, uniformModel, 0, nonUniformModel},
                {"Uniform", "Non-Uniform", 4056, uniformModel, 1, nonUniformModel},
                {"Uniform", "Non-Uniform", 3792, uniformModel, 2, nonUniformModel},
                ...
                {"Non-Uniform", "Uniform", 4122, nonUniformModel, 0, uniformModel},
                {"Non-Uniform", "Uniform", 4122, nonUniformModel, 1, uniformModel},
                {"Non-Uniform", "Uniform", 3929, nonUniformModel, 2, uniformModel},
                {"Non-Uniform", "Uniform", 3145, nonUniformModel, 3, uniformModel},
                {"Non-Uniform", "Non-Uniform", 2235, nonUniformModel, 0, nonUniformModel},
                {"Non-Uniform", "Non-Uniform", 2235, nonUniformModel, 1, nonUniformModel},
                {"Non-Uniform", "Non-Uniform", 2136, nonUniformModel, 2, nonUniformModel},
