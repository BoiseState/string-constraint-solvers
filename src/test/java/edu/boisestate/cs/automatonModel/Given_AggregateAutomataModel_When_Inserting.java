...
public class Given_AggregateAutomataModel_When_Inserting {
    ...
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Non-uniform", "Empty String", 81, nonUniformModel, 1, emptyStringModel},
                {"Non-uniform", "Empty String", 71, nonUniformModel, 2, emptyStringModel},
                {"Non-uniform", "Empty String", 37, nonUniformModel, 3, emptyStringModel},
                {"Non-uniform", "Concrete", 45, nonUniformModel, 0, concreteModel},
                {"Non-uniform", "Concrete", 81, nonUniformModel, 1, concreteModel},
                {"Non-uniform", "Concrete", 71, nonUniformModel, 2, concreteModel},
                {"Non-uniform", "Concrete", 37, nonUniformModel, 3, concreteModel},
                {"Non-uniform", "Uniform", 3825, nonUniformModel, 0, uniformModel},
                {"Non-uniform", "Uniform", 6885, nonUniformModel, 1, uniformModel},
                {"Non-uniform", "Uniform", 6035, nonUniformModel, 2, uniformModel},
                {"Non-uniform", "Uniform", 3145, nonUniformModel, 3, uniformModel},
                {"Non-uniform", "Non-uniform", 2025, nonUniformModel, 0, nonUniformModel},
                {"Non-uniform", "Non-uniform", 3645, nonUniformModel, 1, nonUniformModel},
                {"Non-uniform", "Non-uniform", 3195, nonUniformModel, 2, nonUniformModel},
