...
public class Given_BoundedAutomatonModel_When_Inserting {
    ...
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Uniform", "Uniform", 5457, uniformModel, 0, uniformModel},
                {"Uniform", "Uniform", 5456, uniformModel, 1, uniformModel},
                {"Uniform", "Uniform", 5457, uniformModel, 2, uniformModel},
                {"Uniform", "Uniform", 5457, uniformModel, 3, uniformModel},
                {"Uniform", "Non-uniform", 3825, uniformModel, 0, nonUniformModel},
                {"Uniform", "Non-uniform", 3825, uniformModel, 1, nonUniformModel},
                {"Uniform", "Non-uniform", 3825, uniformModel, 2, nonUniformModel},
                {"Uniform", "Non-uniform", 3825, uniformModel, 3, nonUniformModel},
