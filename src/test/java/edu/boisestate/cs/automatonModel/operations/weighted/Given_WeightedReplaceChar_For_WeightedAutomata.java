...
public class Given_WeightedReplaceChar_For_WeightedAutomata {
    ...
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Concrete", 1, concrete, 'A', 'A'},
                {"Concrete", 1, concrete, 'A', 'B'},
                {"Concrete", 1, concrete, 'A', 'C'},
                {"Concrete", 1, concrete, 'A', 'D'},
                {"Concrete", 1, concrete, 'B', 'A'},
                {"Concrete", 1, concrete, 'B', 'B'},
                {"Concrete", 1, concrete, 'B', 'C'},
                {"Concrete", 1, concrete, 'B', 'D'},
                {"Concrete", 1, concrete, 'C', 'A'},
                {"Concrete", 1, concrete, 'C', 'B'},
                {"Concrete", 1, concrete, 'C', 'C'},
                {"Concrete", 1, concrete, 'C', 'D'},
                {"Concrete", 1, concrete, 'D', 'A'},
                {"Concrete", 1, concrete, 'D', 'B'},
                {"Concrete", 1, concrete, 'D', 'C'},
                {"Concrete", 1, concrete, 'D', 'D'},
    ...
    public void it_should_return_the_correct_model_count() {
        ...
        // *** assert ***
        String reason = String.format("<%s Automaton>.replace('%c', '%c')", description, find, replace);
