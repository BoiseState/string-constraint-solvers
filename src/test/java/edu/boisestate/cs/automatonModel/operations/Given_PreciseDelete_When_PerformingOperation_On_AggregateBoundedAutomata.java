...
Given_PreciseDelete_When_PerformingOperation_On_AggregateBoundedAutomata {
    ...
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {0, 1, new int[]{1,1,2,3,4}, new int[]{1,1,1,1,1}, new int[]{0,0,1,2,3}, 85},
                {0, 2, new int[]{1,1,1,2,3}, new int[]{1,1,1,1,1}, new int[]{0,0,0,1,2}, 21},
                {0, 3, new int[]{1,1,1,1,2}, new int[]{1,1,1,1,1}, new int[]{0,0,0,0,1}, 5},
                {0, 4, new int[]{1,1,1,1,1}, new int[]{1,1,1,1,1}, new int[]{0,0,0,0,0}, 1},
                {1, 1, new int[]{1,2,3,4,5}, new int[]{1,1,1,1,1}, new int[]{0,1,2,3,4}, 341},
                {1, 2, new int[]{1,2,2,3,4}, new int[]{0,1,1,1,1}, new int[]{0,1,1,2,3}, 85},
                {1, 3, new int[]{1,2,2,2,3}, new int[]{0,1,1,1,1}, new int[]{0,1,1,1,2}, 21},
                {1, 4, new int[]{1,2,2,2,2}, new int[]{0,1,1,1,1}, new int[]{0,1,1,1,1}, 5},
                {2, 2, new int[]{1,2,3,4,5}, new int[]{1,1,1,1,1}, new int[]{0,1,2,3,4}, 341},
                {2, 3, new int[]{1,1,3,3,4}, new int[]{0,0,1,1,1}, new int[]{0,0,2,2,3}, 85},
                {2, 4, new int[]{1,1,3,3,3}, new int[]{0,0,1,1,1}, new int[]{0,0,2,2,2}, 21},
                {3, 3, new int[]{1,2,3,4,5}, new int[]{1,1,1,1,1}, new int[]{0,1,2,3,4}, 341},
                {3, 4, new int[]{1,1,1,4,4}, new int[]{0,0,0,1,1}, new int[]{0,0,0,3,3}, 85},
