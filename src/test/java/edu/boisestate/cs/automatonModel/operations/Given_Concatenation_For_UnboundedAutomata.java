...
public class Given_Concatenation_For_UnboundedAutomata {
    ...
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Uniform base", "Non-uniform arg", 220, uniform, nonUniform},
                {"Non-uniform base", "Concrete arg", 8, nonUniform, concrete},
                {"Non-uniform base", "Uniform arg", 220, nonUniform, uniform},
                {"Non-uniform base",
                 "Non-uniform arg",
                 78,
                 nonUniform,
