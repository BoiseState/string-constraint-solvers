...
public class Given_WeightedAutomatonModel_When_AssertingHasLength {
    ...
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Concrete", 0, concreteModel, 0, 3},
                {"Concrete", 0, concreteModel, 1, 1},
                {"Concrete", 0, concreteModel, 1, 2},
                {"Concrete", 0, concreteModel, 1, 3},
                {"Concrete", 0, concreteModel, 2, 2},
                {"Concrete", 0, concreteModel, 2, 3},
                {"Concrete", 2, concreteModel, 3, 3},
                {"Uniform", 1, uniformModel, 0, 0},
                {"Uniform", 0, uniformModel, 0, 1},
                {"Uniform", 0, uniformModel, 0, 2},
                {"Uniform", 0, uniformModel, 0, 3},
                {"Uniform", 4, uniformModel, 1, 1},
                {"Uniform", 0, uniformModel, 1, 2},
                {"Uniform", 0, uniformModel, 1, 3},
                {"Uniform", 16, uniformModel, 2, 2},
                {"Uniform", 0, uniformModel, 2, 3},
                {"Uniform", 64, uniformModel, 3, 3},
                {"Non-uniform", 0, nonUniformModel, 0, 0},
                {"Non-uniform", 0, nonUniformModel, 0, 1},
                {"Non-uniform", 0, nonUniformModel, 0, 2},
                {"Non-uniform", 0, nonUniformModel, 0, 3},
                {"Non-uniform", 1, nonUniformModel, 1, 1},
                {"Non-uniform", 0, nonUniformModel, 1, 2},
                {"Non-uniform", 0, nonUniformModel, 1, 3},
                {"Non-uniform", 7, nonUniformModel, 2, 2},
                {"Non-uniform", 0, nonUniformModel, 2, 3},
