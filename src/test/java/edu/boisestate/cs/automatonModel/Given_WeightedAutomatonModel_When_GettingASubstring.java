...
public class Given_WeightedAutomatonModel_When_GettingASubstring {
...
//                {"Concrete", 2, concreteModel, 0, 0},
//                {"Concrete", 2, concreteModel, 0, 1},
//                {"Concrete", 2, concreteModel, 0, 2},
//                {"Concrete", 2, concreteModel, 0, 3},
//                {"Concrete", 2, concreteModel, 1, 1},
//                {"Concrete", 2, concreteModel, 1, 2},
//                {"Concrete", 2, concreteModel, 1, 3},
//                {"Concrete", 2, concreteModel, 2, 2},
//                {"Concrete", 2, concreteModel, 2, 3},
//                {"Concrete", 2, concreteModel, 3, 3},
//                {"Uniform", 85, uniformModel, 0, 0},
//                {"Uniform", 84, uniformModel, 0, 1},
//                {"Uniform", 80, uniformModel, 0, 2},
//                {"Uniform", 64, uniformModel, 0, 3},
//                {"Uniform", 84, uniformModel, 1, 1},
//                {"Uniform", 80, uniformModel, 1, 2},
//                {"Uniform", 64, uniformModel, 1, 3},
//                {"Uniform", 80, uniformModel, 2, 2},
//                {"Uniform", 64, uniformModel, 2, 3},
//                {"Uniform", 64, uniformModel, 3, 3},
//                {"Non-Uniform", 45, nonUniformModel, 0, 0},
//                {"Non-Uniform", 45, nonUniformModel, 0, 1},
//                {"Non-Uniform", 44, nonUniformModel, 0, 2},
//                {"Non-Uniform", 37, nonUniformModel, 0, 3},
//                {"Non-Uniform", 45, nonUniformModel, 1, 1},
//                {"Non-Uniform", 44, nonUniformModel, 1, 2},
