...
public class Given_WeightedAutomatonModel_When_Concatenated {
    ...
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Concrete", "Concrete", 4, concreteModel, concreteModel},
                {"Concrete", "Uniform", 170, concreteModel, uniformModel},
                {"Concrete", "Non-uniform", 90, concreteModel, nonUniformModel},
                {"Uniform", "Empty", 0, uniformModel, emptyModel},
                {"Uniform", "Empty String", 85, uniformModel, emptyStringModel},
                {"Uniform", "Concrete", 170, uniformModel, concreteModel},
                ...
                {"Non-uniform", "Concrete", 90, nonUniformModel, concreteModel},
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format( "Expected Model Count Invalid for <%s Automaton Model>.concatenate(<%s Automaton Model>)",
                                       baseDescription,
                                       argDescription);
