...
public class Given_UnboundedAutomatonModel_When_PerformingConcat {
    ...
    public static Iterable<Object[]> data() {
        ...
        BoundedAutomatonModel knownModel =
                new BoundedAutomatonModel(known,
                                          alphabet,
                                          initialBoundLength);
        BoundedAutomatonModel uniformModel =
                new BoundedAutomatonModel(uniform,
                                          alphabet,
                                          initialBoundLength);
        BoundedAutomatonModel nonUniformModel =
                new BoundedAutomatonModel(nonUniform,
                                          alphabet,
                                          initialBoundLength);
