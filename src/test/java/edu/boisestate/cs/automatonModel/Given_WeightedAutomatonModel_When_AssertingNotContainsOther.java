...
public class Given_WeightedAutomatonModel_When_AssertingNotContainsOther {
    ...
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Concrete", "Uniform", 78, concreteModel, uniformModel},
                ...
                {"Uniform", "Non-uniform", 3681, uniformModel, nonUniformModel},
                ...
                {"Non-uniform", "Uniform", 3558, nonUniformModel, uniformModel},
