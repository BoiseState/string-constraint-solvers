...
public class Given_AggregateAutomataModel_When_AssertingEqualsIgnoreCase {
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format( "<%s Automaton Model>.assertEqualsIgnoreCase(<%s Automaton Model>)",
                                       baseDescription,
                                       argDescription);
