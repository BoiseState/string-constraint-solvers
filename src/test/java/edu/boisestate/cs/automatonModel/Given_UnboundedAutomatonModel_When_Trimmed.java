...
public class Given_UnboundedAutomatonModel_When_Trimmed {
    ...
    public static Iterable<Object[]> data() {
        ...
        UnboundedAutomatonModel whiteSpaceConcreteModel = getConcreteUnboundedModel(alphabet," A ");
        UnboundedAutomatonModel noWhiteSpaceConcreteModel = getConcreteUnboundedModel(alphabet,"ABC");
