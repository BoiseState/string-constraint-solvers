...
public class Given_UnboundedAutomatonModel_When_AssertingNotEquals {
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format( "<%s Automaton Model>.assertNotEquals(<%s Automaton Model>)", baseDescription, argDescription);
