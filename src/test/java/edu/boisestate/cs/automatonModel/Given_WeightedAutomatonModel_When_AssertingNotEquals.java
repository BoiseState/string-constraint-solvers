...
public class Given_WeightedAutomatonModel_When_AssertingNotEquals {
    ...
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Uniform", "Uniform", 7140, uniformModel, uniformModel},
                {"Uniform", "Non-uniform", 3780, uniformModel, nonUniformModel},
                ...
                {"Non-uniform", "Uniform", 3780, nonUniformModel, uniformModel},
                {"Non-uniform", "Non-uniform", 1980, nonUniformModel, nonUniformModel}
        });
    }
