...
public class Given_WeightedAutomatonModel_When_AssertingContainedInOther {
    ...
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Uniform", "Non-uniform", 267, uniformModel, nonUniformModel},
                ...
                {"Non-uniform", "Uniform", 144, nonUniformModel, uniformModel},
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format( "Expected Model Count Invalid for <%s Automaton Model>.assertContainedInOther(<%s Automaton Model>)",
                                       baseDescription,
                                       argDescription);
