...
public class Given_ConcreteValues_When_Reversed {
    ...
    @Parameters(name = "{index}: <{0} Values>.reverse() - Expected MC = {1}")
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format("<%s Values>.reverse()", description);
