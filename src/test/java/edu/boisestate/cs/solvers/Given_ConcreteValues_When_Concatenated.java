...
public class Given_ConcreteValues_When_Concatenated {
    ...
    @Parameters(name = "{index}: <{0} Values>.concat(<{1} Values>) - Expected MC = {2}")
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Empty String", "Concrete", 1, emptyStringValues, concreteValues},
                {"Empty String", "Uniform", 85, emptyStringValues, uniformValues},
                {"Empty String", "Non-Uniform", 45, emptyStringValues, nonUniformValues},
                ...
                {"Concrete", "Uniform", 85, concreteValues, uniformValues},
                {"Concrete", "Non-Uniform", 45, concreteValues, nonUniformValues},
                {"Uniform", "Empty", 0, uniformValues, emptyValues},
                {"Uniform", "Empty String", 85, uniformValues, emptyStringValues},
                {"Uniform", "Concrete", 85, uniformValues, concreteValues},
                {"Uniform", "Uniform", 7225, uniformValues, uniformValues},
                {"Uniform", "Non-Uniform", 3825, uniformValues, nonUniformValues},
                {"Non-Uniform", "Empty", 0, nonUniformValues, emptyValues},
                {"Non-Uniform", "Empty String", 45, nonUniformValues, emptyStringValues},
                {"Non-Uniform", "Concrete", 45, nonUniformValues, concreteValues},
                {"Non-Uniform", "Uniform", 3825, nonUniformValues, uniformValues},
                {"Non-Uniform", "Non-Uniform", 2025, nonUniformValues, nonUniformValues}
        });
    }
    ...
    public void setup() {
        // *** act ***
        resultValues = baseValues.concat(argValues);
    }
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format( "<%s Values>.concat(<%s Values>)", baseDescription, argDescription);
