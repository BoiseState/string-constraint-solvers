...
public class Given_ConcreteValues_When_AssertingStartsOther {
    ...
    @Parameters(name = "{index}: <{0} Values>.assertStartsOther(<{1} Values>) - Expected MC = {2}")
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Uniform", "Concrete", 4, uniformValues, concreteValues},
    ...
    public void setup() {
        // *** act ***
        resultValues = baseValues.assertStartsOther(argValues);
    }
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format( "<%s Values>.assertStartsOther(<%s Values>)", baseDescription, argDescription);
