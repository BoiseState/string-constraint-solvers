...
public class Given_ConcreteValues_When_AssertingEqual {
    ...
    @Parameters(name = "{index}: <{0} Values>.assertEqual(<{1} Values>) - Expected MC = {2}")
    ...
    public void setup() {
        // *** act ***
        resultValues = baseValues.assertEqual(argValues);
    }
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format( "<%s Values>.assertEqual(<%s Values>)", baseDescription, argDescription);
