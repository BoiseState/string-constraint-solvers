...
public class Given_ConcreteValues_When_AssertingNotContainsOther {
    ...
    @Parameters(name = "{index}: <{0} Values>.assertNotContainsOther(<{1} Values>) - Expected MC = {2}")
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Concrete", "Empty String", 0, concreteValues, emptyStringValues},
                ...
                {"Uniform", "Empty String", 0, uniformValues, emptyStringValues},
                {"Uniform", "Concrete", 84, uniformValues, concreteValues},
                {"Uniform", "Uniform", 85, uniformValues, uniformValues},
                {"Uniform", "Non-Uniform", 85, uniformValues, nonUniformValues},
                {"Non-Uniform", "Empty", 0, nonUniformValues, emptyValues},
                {"Non-Uniform", "Empty String", 0, nonUniformValues, emptyStringValues},
                {"Non-Uniform", "Concrete", 44, nonUniformValues, concreteValues},
    ...
    public void setup() {
        // *** act ***
        resultValues = baseValues.assertNotContainsOther(argValues);
    }
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format( "<%s Values>.assertNotContainsOther(<%s Values>)", baseDescription, argDescription);
