...
public class Given_ConcreteValues_When_AssertingEqualIgnoreCase {
    ...
    @Parameters(name = "{index}: <{0} Values>.assertEqualIgnoreCase(<{1} Values>) - Expected MC = {2}")
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Empty String", "Concrete Lower", 0, emptyStringValues, lowerConcreteValues},
                {"Empty String", "Concrete Upper", 0, emptyStringValues, upperConcreteValues},
                ...
                {"Concrete Lower", "Empty String", 0, lowerConcreteValues, emptyStringValues},
                {"Concrete Lower", "Concrete Lower", 1, lowerConcreteValues, lowerConcreteValues},
                {"Concrete Lower", "Concrete Upper", 1, lowerConcreteValues, upperConcreteValues},
                ...
                {"Concrete Upper", "Empty String", 0, upperConcreteValues, emptyStringValues},
                {"Concrete Upper", "Concrete Lower", 1, upperConcreteValues, lowerConcreteValues},
                {"Concrete Upper", "Concrete Upper", 1, upperConcreteValues, upperConcreteValues},
                ...
                {"Uniform", "Empty String", 1, uniformValues, emptyStringValues},
                {"Uniform", "Concrete Lower", 8, uniformValues, lowerConcreteValues},
                {"Uniform", "Concrete Upper", 8, uniformValues, upperConcreteValues},
                {"Uniform", "Uniform", 585, uniformValues, uniformValues},
                {"Uniform", "Non-Uniform", 326, uniformValues, nonUniformValues},
                {"Non-Uniform", "Empty", 0, nonUniformValues, emptyValues},
                {"Non-Uniform", "Empty String", 0, nonUniformValues, emptyStringValues},
                {"Non-Uniform", "Concrete Lower", 4, nonUniformValues, lowerConcreteValues},
                {"Non-Uniform", "Concrete Upper", 4, nonUniformValues, upperConcreteValues},
    ...
    public void setup() {
        // *** act ***
        resultValues = baseValues.assertEqualIgnoreCase(argValues);
    }
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format( "<%s Values>.assertEqualIgnoreCase(<%s Values>)", baseDescription, argDescription);
