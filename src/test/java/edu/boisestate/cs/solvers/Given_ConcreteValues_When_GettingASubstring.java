...
public class Given_ConcreteValues_When_GettingASubstring {
    ...
    @Parameters(name = "{index}: <{0} Values>.substring({3},{4}) - Expected MC = {1}")
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Empty String", 0, emptyStringValues, 0, 1},
                {"Empty String", 0, emptyStringValues, 0, 2},
                {"Empty String", 0, emptyStringValues, 0, 3},
                ...
                {"Uniform", 84, uniformValues, 0, 1},
                {"Uniform", 80, uniformValues, 0, 2},
                {"Uniform", 64, uniformValues, 0, 3},
                {"Uniform", 84, uniformValues, 1, 1},
                {"Uniform", 80, uniformValues, 1, 2},
                {"Uniform", 64, uniformValues, 1, 3},
                {"Uniform", 80, uniformValues, 2, 2},
                {"Uniform", 64, uniformValues, 2, 3},
                {"Uniform", 64, uniformValues, 3, 3},
                {"Non-Uniform", 45, nonUniformValues, 0, 0},
                {"Non-Uniform", 45, nonUniformValues, 0, 1},
                {"Non-Uniform", 44, nonUniformValues, 0, 2},
                {"Non-Uniform", 37, nonUniformValues, 0, 3},
                {"Non-Uniform", 45, nonUniformValues, 1, 1},
                {"Non-Uniform", 44, nonUniformValues, 1, 2},
                {"Non-Uniform", 37, nonUniformValues, 1, 3},
                {"Non-Uniform", 44, nonUniformValues, 2, 2},
                {"Non-Uniform", 37, nonUniformValues, 2, 3},
    ...
    public void setup() {
        // *** act ***
        resultValues = values.substring(start, end);
    }
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format("<%s Values>.substring(%d, %d)", description, start, end);
