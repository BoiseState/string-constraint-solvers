...
public class Given_ConcreteValues_When_AssertingNotEmpty {
    ...
    @Parameters(name = "{index}: <{0} Values>.assertNotEmpty() - Expected MC = {1}")
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                {"Empty", 0, emptyValues},
                {"Empty String", 0, emptyStringValues},
                {"Concrete", 1, concreteValues},
                {"Uniform", 84, uniformValues},
                {"Non-Uniform", 45, nonUniformValues}
        });
    }
    ...
    public void setup() {
        // *** act ***
        resultValues = values.assertNotEmpty();
    }
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format("<%s Values>.assertNotEmpty()", description);
