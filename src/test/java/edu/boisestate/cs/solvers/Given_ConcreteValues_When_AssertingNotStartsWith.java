...
public class Given_ConcreteValues_When_AssertingNotStartsWith {
    ...
    @Parameters(name = "{index}: <{0} Values>.assertNotStartsWith(<{1} Values>) - Expected MC = {2}")
    ...
    public void setup() {
        // *** act ***
        resultValues = baseValues.assertNotStartsWith(argValues);
    }
