...
public class Given_ConcreteValues_When_ConvertingToLowerCase {
    ...
    @Parameters(name = "{index}: <{0} Values>.toLowerCase() - Expected MC = {1}")
    ...
    public void setup() {
        // *** act ***
        resultValues = values.toLowerCase();
    }
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format("<%s Values>.toLowerCase()", description);
