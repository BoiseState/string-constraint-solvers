...
public class Given_ConcreteValues_When_AssertingNotEndsOther {
    ...
    @Parameters(name = "{index}: <{0} Values>.assertNotEndsOther(<{1} Values>) - Expected MC = {2}")
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"Uniform", "Concrete", 81, uniformValues, concreteValues},
                {"Uniform", "Uniform", 84, uniformValues, uniformValues},
                {"Uniform", "Non-Uniform", 84, uniformValues, nonUniformValues},
    ...
    public void setup() {
        // *** act ***
        resultValues = baseValues.assertNotEndsOther(argValues);
    }
    ...
    public void it_should_have_the_correct_number_of_accepted_strings() {
        ...
        // *** assert ***
        String reason = String.format( "<%s Values>.assertNotEndsOther(<%s Values>)", baseDescription, argDescription);
