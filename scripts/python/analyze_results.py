...
GLOB['len-match'][4] = re.compile('.*-04(-\d{2})?.csv')
...
GLOB['alphabet-match']['AE'] = re.compile('.*-AE-\d{2}(-\d{2})?.csv')
...
OP_NORMS = {
    'concat': {
        ...
        'Even': {
            'AB': {1: 12, 2: 12, 3: 12, 4: 0},
            'AC': {1: 12, 2: 12, 3: 12, 4: 0},
            'AD': {1: 12, 2: 12, 3: 12, 4: 0},
            'AE': {1: 12, 2: 12, 3: 12, 4: 0}
        },
        'Uneven': {
            'AB': {1: 12, 2: 12, 3: 12, 4: 0},
            'AC': {1: 12, 2: 12, 3: 12, 4: 0},
